...
<template>
    <div class="bg-white bg-cover md:bg-contain lg:bg-cover md:bg-center" :style="{ backgroundImage: `url(${bgImage})` }">
        <div id="contacto" ref="contacto" class="section container mx-auto px-4 py-12 md:py-20 xl:py-24">
