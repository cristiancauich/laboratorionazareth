    ...
    <div class="container">
      <div class="site-navigation">
        <a href="" class="logo m-0 float-left"
          >
          <img :src="logo" alt="Labdotphase Logo" class="img-fluid" width="170" height="35"/>
        ...
        <ul class="js-clone-nav d-none d-lg-inline-block site-menu float-left">
          ...
          <li><a href="#pricing-section" class="nav-link">Destacados</a></li>
          <li><a href="#about-section" class="nav-link">¿Quiénes somos?</a></li>
